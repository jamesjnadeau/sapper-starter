/**
 * I copied this from: http://hint.fm/wind/wind-bundle.js
 * 
...
Animator.prototype.zoomClick = function(x, y) {
	...
	console.log({x: x, y:y, dx: this.dx, dy: this.dy });
...
},
{
 city: 'Whitehall',
 state: 'New York',
 lat: 43.55252937447483,
 lon: -73.40034484863281,
 pop: 145170 // actual ?
},
{
 city: 'Lebanon',
